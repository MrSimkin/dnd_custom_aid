...
Usage:
    python expand_para_hoja_de_pj_v2.py INPUT.ttf OUTPUT.ttf
...
def main() -> int:
    if len(sys.argv) != 3:
        print("Usage: python expand_para_hoja_de_pj_v2.py INPUT.ttf OUTPUT.ttf", file=sys.stderr)
        return 2
    ...
    set_name(font, 1, "Para Hoja de PJ Symbols v2")
    set_name(font, 2, "Regular")
    set_name(font, 4, "Para Hoja de PJ Symbols v2 Regular")
    set_name(font, 5, "Version 2.00 2026-09-18; expanded renderer symbol set")
    set_name(font, 6, "ParaHojadePJSymbolsV2-Regular")
    set_name(font, 16, "Para Hoja de PJ Symbols v2")
