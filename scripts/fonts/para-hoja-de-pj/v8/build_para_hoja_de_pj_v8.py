...
EXPECTED_TTF_SHA256 = "f8f7eeed331be34ea08da23bb165f200c8313e1ba670667466ad8e1aebf77d8b"
...
def smooth_six_glyph():
    """v8 ordinary monoline-style 6: light closed bowl with a restrained upper sweep."""
    outer = [
    (1267.42, 516.77),(1260.73, 446.98),(1250.17, 403.49),(1223.99, 337.84),(1183.01, 272.00),(1154.05, 237.55),(1095.83, 185.10),(1028.96, 142.93),(960.67, 113.87),(916.91, 101.28),(837.55, 88.94),(762.45, 88.94),(683.09, 101.28),(607.09, 126.06),(566.08, 145.54),(499.59, 188.61),(445.95, 237.55),(416.99, 272.00),(378.85, 332.30),(360.32, 373.12),(340.48, 440.68),(332.58, 516.77),(334.71, 561.45),(348.04, 630.40),(369.25, 687.25),(334.78, 725.94),(316.91, 753.32),(290.53, 813.29),(276.72, 878.36),(275.21, 946.73),(279.77, 987.02),(295.19, 1052.61),(309.35, 1092.61),(341.11, 1159.43),(390.26, 1237.10),(420.73, 1277.21),(489.58, 1350.96),(560.47, 1408.63),(597.28, 1432.81),(668.49, 1470.23),(749.24, 1499.53),(787.54, 1508.95),(858.51, 1519.07),(900.49, 1520.52),(967.33, 1515.42),(1040.58, 1497.92),(1097.27, 1473.47),(1125.85, 1456.31),(1176.65, 1413.78),(1083.35, 1316.22),(1052.25, 1343.08),(995.52, 1370.62),(924.09, 1384.50),(870.41, 1384.57),(813.51, 1376.45),(754.75, 1359.55),(695.47, 1333.35),(636.89, 1297.32),(580.22, 1250.90),(552.98, 1223.60),(501.39, 1160.42),(460.09, 1095.61),(434.11, 1040.97),(417.64, 988.72),(410.07, 939.92),(410.66, 895.55),(424.95, 838.73),(446.25, 802.75),(504.17, 854.90),(566.08, 894.46),(639.33, 926.13),(717.16, 945.61),(797.31, 952.45),(877.51, 946.47),(955.47, 927.86),(998.01, 911.77),(1068.15, 874.28),(1126.14, 829.88),(1158.08, 798.06),(1201.76, 741.14),(1237.34, 672.74),(1251.96, 630.40),(1265.29, 561.45),
]
    inner = [
    (1127.57, 570.57),(1113.11, 619.81),(1102.35, 643.52),(1074.05, 688.23),(1037.29, 728.19),(993.05, 762.06),(942.59, 788.64),(887.48, 806.94),(829.48, 816.27),(770.52, 816.27),(712.52, 806.94),(657.41, 788.64),(606.95, 762.06),(583.97, 745.97),(543.32, 708.89),(509.37, 664.05),(492.52, 616.35),(486.44, 618.50),(472.43, 570.57),(468.79, 545.36),(468.79, 494.64),(478.47, 444.56),(486.89, 420.19),(510.70, 373.62),(543.32, 331.11),(583.97, 294.03),(631.50, 263.67),(657.41, 251.36),(712.52, 233.06),(770.52, 223.73),(829.48, 223.73),(887.48, 233.06),(942.59, 251.36),(993.05, 277.94),(1016.03, 294.03),(1056.68, 331.11),(1089.30, 373.62),(1102.35, 396.48),(1121.53, 444.56),(1131.21, 494.64),(1131.21, 545.36),
]
    # The contour directions are already opposite (outer clockwise, counter clockwise),
    # producing one clean counter with no overlap seam at the sweep/bowl join.
    return contours_glyph([(outer, False), (inner, False)])
...
def digit_glyph(digit: str):
    """Ordinary rounded/sans numerals; v8 preserves the accepted numeral set and redraws only 6 and 9."""
    w = 135
    if digit == '0':
...
def build(v1_path: Path, out: Path) -> None:
    ...
    fb.setupNameTable({'familyName':'Para Hoja de PJ Symbols v8','styleName':'Regular','uniqueFontIdentifier':'GustavoMunoz: Para Hoja de PJ Symbols v8: 8.00: 2026-09-18','fullName':'Para Hoja de PJ Symbols v8 Regular','psName':'ParaHojadePJSymbolsV8-Regular','version':'Version 8.00; 2026-09-18','manufacturer':'Gustavo Munoz / DnD Custom Aid','designer':'Gustavo Munoz; technical reconstruction assisted by OpenAI','description':'Owner-authored symbol font. v8 preserves exact v1 A-E geometry, the accepted v7 symbol/mark system, and all accepted numerals except 6/9; 6 and 9 are redrawn as lighter ordinary ring-and-sweep forms matching the surrounding numeral family.','licenseDescription':'Owner-authored font. Public repository publication and project modification/versioning authorized by Gustavo Munoz for DnD Custom Aid.'})
    ...
    if EXPECTED_TTF_SHA256 != 'TO_BE_FILLED' and built != EXPECTED_TTF_SHA256:
        out.unlink(missing_ok=True); raise RuntimeError(f'v8 deterministic SHA mismatch: {built}')
