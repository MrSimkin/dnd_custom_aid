...
**Current active route:** PC Sheet PDF — `0.5.0-preqa.5` candidate is repository-green; next boundary is the bounded Aldren/Permanente four-family owner rerun  
