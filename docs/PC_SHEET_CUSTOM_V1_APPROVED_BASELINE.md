# Custom v1 — Approved PDF Visual Baseline

This file is the **stable pointer** to the currently owner-approved Custom v1 PDF visual baseline.

Do not use chat memory to reconstruct the approved state.

## Current approved baseline

- Strategy: **Hybrid / Strategy 1**
- Visual draft: **Run 7 final coordinate calibration**
- Owner status: **APPROVED**
- Rendering commit: `7448693e36ee1b26243bd4091615dba725e95027`
- Scaffold: `35465731044` / run #2708 — SUCCESS
- Artifact: `pc-sheet-populated-template-proofs`
- Artifact id: `10591616012`
- PDF: `hybrid-strategy1-run7-composite.pdf`
