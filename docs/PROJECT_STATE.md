...
**Current active package:** PC Sheet PDF Export — Custom v1 Extended Run-6 owner review
...
Para Hoja de PJ Symbols v8 is OWNER APPROVED / FROZEN. Custom v1 base pages, Custom v2 per-Attribute base pages and Custom v2 per-Ability base pages are owner-approved/frozen. Classic Run 2 corrected complete family is OWNER APPROVED / FROZEN at `3dbcff8f5f9a2413f6deb8e400daeb6288b4f6b1`. Classic Run 1 is owner-rejected historical evidence only. Custom-v1 Extended Run 1 is owner-rejected historical evidence. Run 2 established the source-faithful extension direction but received bounded owner feedback on page-6 artifacts, block selection and typography. Custom-v1 Extended Runs 3, 4 and 5 were owner-reviewed and not approved. Custom-v1 Extended Run 6 is now the audited 11-page owner-review candidate (`69b308f3d5d493d06bd0107ac66c7524935aa9fa`, Scaffold #2885 SUCCESS, artifact `10609869599`); it preserves frozen pages 1–5, restores page-6 source typography/naming/vertical cadence, restores compact Custom-v1 proportions on page 8, and returns the Equipment/Gemas continuation to its proven regular-body treatment. Custom-v2 family-matched Extended-page design/QA remains pending. Do not describe either Custom family as fully closed until its extension set receives explicit owner approval.
