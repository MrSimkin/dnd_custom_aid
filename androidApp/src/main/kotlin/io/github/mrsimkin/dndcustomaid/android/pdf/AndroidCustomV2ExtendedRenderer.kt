// GENERATED by scripts/generate_android_pc_sheet_renderer.py from DesktopCustomV2ExtendedRenderer.kt.
 ...
 */
internal class AndroidCustomV2ExtendedRenderer(
                ...
                for (y in 0 until height) {
                    for (x in 0 until width) {
                        if (insideValueMask(x, y)) {
                            transparent.setPixel(x, y, 0)
                            continue
                        }
                        val rgb = sourceImage.getPixel(x0 + x, y0 + y)
                        ...
                        transparent.setPixel(x, y, alpha shl 24)
                    }
                }
