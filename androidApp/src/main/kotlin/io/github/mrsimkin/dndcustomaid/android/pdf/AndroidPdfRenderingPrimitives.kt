// GENERATED by scripts/generate_android_pc_sheet_renderer.py from DesktopPdfRenderingPrimitives.kt.
...
internal class AndroidPdfFontRegistry(
    ...
    private val resourceLoader: (String) -> InputStream? = { path ->
        AndroidPcSheetAssetLoader.open(path)
    },
) {
...
internal class AndroidPdfRenderingPrimitives(
    private val fonts: AndroidPdfFontRegistry,
) {
