// GENERATED by scripts/generate_android_pc_sheet_renderer.py from DesktopPcSheetVisualCompletionRenderer.kt.
 ...
 */
internal class AndroidPcSheetVisualCompletionRenderer(
    ...
    private val primitives by lazy {
        AndroidPdfRenderingPrimitives(
            AndroidPdfFontRegistry(document, resourceLoader = resourceLoader),
        )
    }
    ...
    private fun duplicatePagesAfterMain(
        ...
        val imported = PDDocument.load(sourceBytes).use { source ->
