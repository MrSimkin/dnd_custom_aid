// GENERATED by scripts/generate_android_pc_sheet_renderer.py from DesktopPcSheetTemplateProofRenderer.kt.
...
internal class AndroidPcSheetTemplateProofRenderer(
        ...
        template.use { input ->
            PDDocument.load(input.readBytes()).use { document ->
                ...
                val primitives = AndroidPdfRenderingPrimitives(
                    AndroidPdfFontRegistry(document, CUSTOM_APPROVED_TYPOGRAPHY_THEME, resourceLoader),
                )
