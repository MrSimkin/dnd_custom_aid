...
internal class DesktopPdfRenderingPrimitives(
    ...
    private fun approvedSymbolGlyph(
        ...
        PdfSymbolFamily.V1_DERIVED -> when (kind) {
            ...
            PdfMarkerKind.OVAL_OUTLINE -> ApprovedSymbolGlyph(0xE205, 240, 0, 1360, 1600)
            PdfMarkerKind.OVAL_FILLED -> ApprovedSymbolGlyph(0xE206, 240, 0, 1360, 1600)
        ...
        PdfSymbolFamily.V3_DERIVED -> when (kind) {
            ...
            PdfMarkerKind.OVAL_OUTLINE -> ApprovedSymbolGlyph(0xE305, 240, 40, 1360, 1560)
            PdfMarkerKind.OVAL_FILLED -> ApprovedSymbolGlyph(0xE306, 240, 40, 1360, 1560)
